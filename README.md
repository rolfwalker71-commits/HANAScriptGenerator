...
Auf dem Server schon vorhandene `export.conf` und `export_schemas.txt` werden
dabei nicht überschrieben: beide werden dort gepflegt, ein erneutes Übertragen
soll diese Änderungen nicht zurücksetzen.
